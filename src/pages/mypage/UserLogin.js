    ...
    >
      <div style={{ width: "360px", alignContent: "center" }}>
        <div style={{ display: "flex", width: "240px", cursor: "pointer", marginLeft: "20px" }} onClick={handleHome}>
          ...
          <div style={{ flex: "2", fontSize: "36px", fontWeight: "bold", textAlign: "center", lineHeight: "120px" }}>
            샵피트
          </div>
        </div>
        ...
        <div style={{ display: "flex" }}>
          <div style={{ flex: "1", textAlign: "center" }}>
            <Link to="/mypage/edit/password" style={{ textDecoration: "none", color: "white" }}>
              비밀번호 재설정
            </Link>
          </div>
        ...
        {errorModalOpen && <Modal errorMessage={errorMessage} onClose={handleCloseModal} />}
      </div>
    </div>
  );
};
